...
// STEPIEN: Changed the following code from just transmitting to transmit and receive.
//          The reason for doing this is that the data line into the touch panel device
