...
//        ADS.RDATA();
//        Serial.print(ADS.transfer(0x00), HEX);
//       Serial.print(ADS.transfer(0x00), HEX);
//  Serial.print(ADS.transfer(0x00), HEX);
//    Serial.print(ADS.transfer(0x00), HEX);
//  Serial.print(ADS.transfer(0x00), HEX);
...
//
//    Serial.println();
//    Serial.println("Single Sample read");
//      while(1) {
//      }
//    }
//  }
  ...
  ADS.WREG(CH2SET, 0x00);
  ADS.WREG(CH3SET, 0x00);
  ADS.WREG(CH4SET, 0x00);
  ADS.WREG(CH5SET, 0x00);
  ADS.WREG(CH6SET, 0x00);
  ADS.WREG(CH7SET, 0x00);
  ADS.WREG(CH8SET, 0x00);
  ADS.RDATAC();
